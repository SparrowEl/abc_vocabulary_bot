...
bot = TeleBot(token='6967453423:AAEGNoIKqK2N0olD-zBvu-nF7Sj9clL0Cxg', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Здравствуй! Я помогу тебе расшифровать сложные аббревиатуры и термины 🤓\nВведи интересующий термин, например, смоук', # текст сообщения
    )
...
def message_handler(message: types.Message):
    ...
    if definition is None:
        ...
        bot.send_message(
            ...
            text='😋 Я пока не знаю такого определения. Но я быстро учусь!',
        )
        # выходим из функции
        return
